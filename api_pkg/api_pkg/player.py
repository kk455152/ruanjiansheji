...
def player_control():
    ...
    save_player_control(device_id, action, song, is_playing, body)
...
def player_volume():
    ...
    save_player_volume(device_id, volume, body)
...
def play_song():
    ...
    device_id = str(body.get("deviceId") or "dev_001").strip()
    ...
    song = {
        ...
        "coverUrl": str(body.get("coverUrl") or ""),
        "durationMs": int(body.get("durationMs") or 0),
        "durationSeconds": int(body.get("durationSeconds") or 0),
        "source": source,
    }
    ...
    save_play_song(device_id, song, body)
...
def add_next():
    ...
    save_add_next(device_id, song, song_id, body)
